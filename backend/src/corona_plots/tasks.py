...
def update_database(csv_file, case_status_type_id, column_keys):
...
def do_data_update():
    ...
    for case_status_type_name, csv_file in zip(case_status_type_names, csv_global_files):
        update_database(csv_file, case_status_type_name, global_keys)

    for case_status_type_name, csv_file in zip(case_status_type_names[:2], csv_us_files):
        update_database(csv_file, case_status_type_name, us_keys)
